...
@protocol EngageAdExpansionCallback;

SWIFT_CLASS("_TtC4IMAd21EngageAdConfiguration")
@interface EngageAdConfiguration : NSObject
- (nonnull instancetype)initWithAvailableArea:(CGRect)availableArea expansionCallback:(id <EngageAdExpansionCallback> _Nullable)expansionCallback OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_PROTOCOL("_TtP4IMAd25EngageAdExpansionCallback_")
@protocol EngageAdExpansionCallback
- (UIView * _Nonnull)getExpandedContainer SWIFT_WARN_UNUSED_RESULT;
@end
